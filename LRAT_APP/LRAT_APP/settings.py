"""
Django settings for LRAT_APP project.
...
WSGI_APPLICATION = 'LRAT_APP.wsgi.application'
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "lrat_db"),
        "USER": os.environ.get("POSTGRES_USER", "lrat_user"),
